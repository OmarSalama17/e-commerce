...
async function fetchProducts() {
    try {
        const firstApi = fetch('https://fakestoreapiserver.reactbd.com/smart').then(res => res.json());

        const secondApi = fetch('https://fakestoreapiserver.reactbd.com/tech').then(res => res.json())

        const thirdApi = fetch('https://fakestoreapiserver.reactbd.com/next').then(res => res.json())

        const [first, second, third] = await Promise.all([firstApi, secondApi, thirdApi]);

        const combinedProducts = [...first, ...second, ...third];
